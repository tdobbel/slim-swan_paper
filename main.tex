...
\begin{frontmatter}
    ...
    \title{Impacts of Hurricane Irma (2017) on wave-induced ocean transport processes}%Impacts of Hurricane Irma (2017) on ocean transport processes}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/fig_mesh_hurr.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.95\textwidth]{figures/figure_initial_positions.png}
