...
\begin{frontmatter}
    ...
    \begin{abstract}
        The frequency of major tropical cyclines has increased during the past decade. Their effect is particularly acute in coastal areas where they cause extensive damage leading to an influx of debris, sediments and waste to the sea. However, the default setting of most operational coastal ocean models do not represent heavy-wind transport processes correctly as they do not couple the hydrodynamics with the wind-generated waves. This may lead to significant errors in ocean simulations under tropical cyclone conditions. Here, we investigate current-wave interactions during a major hurricane and assess their impact on transport processes. We do that by coupling the unstructured-mesh coastal ocean model SLIM with the spectral wave model SWAN, and applying it to the Florida Reef Tract during Hurricane Irma (September 17). We show that the coupled model successfully reproduces the wave behavior, the storm surge and the ocean currents during the passage of the hurricane. We then use the coupled and uncoupled wave-current model to simulate the transport of passive drifters. We show that the wave radiation stress gradient alone can lead to changes of up to 1 m/s in the modeled currents, which in turn leads to differences of up to 5 km in the position of drifting material over the duration of the hurricane. The Stokes drift however appears to cause deflections up to 4 times more intense and should thus be considered in priority. Wave-current interactions therefore strongly impact the transport of drifting material such as sediments and debris in the aftermath of a hurricane. They should thus be taken into account in order to correctly assess its overall impact.
    \end{abstract}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{fig_mesh_hurr.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.99\textwidth]{hwind_vs_era_noletter.png}
    \includegraphics[width=.99\textwidth]{holland_vs_era_noletter.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.95\textwidth]{inner_outer_regions.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{elevation_with_map.png}
...
\end{figure}
\begin{figure}
    \includegraphics[width=\textwidth]{validation_currents_C10_ww3.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{hsig_with_map_ww3.png}
    \includegraphics[width=\textwidth]{waves_ww3_5km-00002.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{max_diff_reefs.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.99\textwidth]{inner_outer.png}
