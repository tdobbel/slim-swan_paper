...
\begin{figure}
    ...
    \caption{Schematic illustration of the coupled SLIM+SWAN model \emphc{[add U10 to diagram]}.}
    \label{fig:coupling}
\end{figure}
...
\emphc{[include error statistics (e.g. mean bias, absolute error, and RMSE) + present them in a table]}
...
\subsection{Impact of waves on currents and transport \emphc{[Add dispersion analysis]}}
...
\emphc{[Milan: Two first points could be well summarized in table -\_-]}
