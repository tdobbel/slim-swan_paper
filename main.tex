...
%-- From the paper of Liu et al. (2019)
% Hurricanes and tropical/extratropical storms disturb ocean con- ditions and may cause varying levels ofdamage to coastal com- munities. In open ocean regions, hurricane impacts include the mixing of deeper water properties into the surface layer, direct air–sea exchange ofmoisture and heat from the sea surface, and the generation of near-inertial currents and surface and internal waves (e.g., Price 1981;Shayetal. 1990, 1992; Sanford et al. 2011;D’Asaro et al. 2014; Zhang et al. 2016). On continental shelves, hurricanes can cause coastal upwelling (or downwelling) (e.g., Smith 1982), rapid shelf-wide cooling (e.g., Zambon et al. 2014; Glenn et al. 2016; Seroka et al. 2017), and near-inertial currents (e.g., Teague et al. 2007; Shen et al. 2017; Zhang et al. 2018). In nearshore and coastal regions, hurricanes can induce strong currents, waves, and storm surges (e.g., Weisberg and Zheng 2006b, 2008; Dietrich et al. 2010;Yanget al. 2014;Marsooliand Lin 2018). While most studies focus on positive storm surges that are known to cause property damage to the coastal community (e.g., Huang et al. 2010; Liu et al. 2013; Zheng et al. 2013; Bilskie et al. 2016;Wu et al. 2018), there are fewer works reporting on negative surges, which may also affect water exchanges between the estuaries and the coastal ocean (e.g., Chen et al. 2018) and disturb the benthic ecosystems (e.g., Van Diggelen and Montagna 2016; Wachnicka et al. 2019;Browder andZink 2019)
% ---  end of Liu et al. (2019)
...
\begin{itemize}
    \item Damages mostly due to hydrodynamic forces in the Florida Keys \citep{xian2018brief}
\end{itemize}
